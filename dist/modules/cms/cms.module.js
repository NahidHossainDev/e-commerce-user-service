...
exports.CmsModule = CmsModule = __decorate([
    (0, common_1.Module)({
        imports: [pages_module_1.CmsPagesModule, components_module_1.CmsComponentsModule],
        exports: [pages_module_1.CmsPagesModule, components_module_1.CmsComponentsModule],
    })
], CmsModule);
