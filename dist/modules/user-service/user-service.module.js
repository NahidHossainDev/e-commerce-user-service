...
exports.UserServiceModule = UserServiceModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_module_1.AuthModule, user_module_1.UserModule, address_module_1.AddressModule],
        exports: [auth_module_1.AuthModule, user_module_1.UserModule, address_module_1.AddressModule],
    })
], UserServiceModule);
