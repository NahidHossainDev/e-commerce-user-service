  ...
  return {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
        ...
        <a href="${data.url}" style="display: inline-block; padding: 10px 20px; background-color: #00a651; color: #fff; text-decoration: none; border-radius: 5px; margin-top: 10px;">Verify Email</a>
